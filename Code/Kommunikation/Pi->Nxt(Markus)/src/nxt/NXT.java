...
import datatype.Buttons;
import datatype.Motors;
import datatype.NXTMessage;
import datatype.UltrasonicSensors;
...
public class NXT {
     ...
     *
     * @param runTime the time, when the commands in the messages should be executed
     */
     ...
     * @param delay the delay between sending arrays of commands
     */
     ...
     *
     * @param listener the NewMessageListener
     */
     ...
     *
     * @param nxtMessages the new messages
     */
